...
public class Mod05AudioBook extends Mod05Book implements Mod05IAudioMedia {
    private String isrc; 
    ...
    public Mod05AudioBook(String title, String genre, int yearCreated, int chapters,
    ...
    @Override
    public Mod05MediaTypes getType() {
        return Mod05MediaTypes.AUDIO_BOOK;
    }
    

    public static void main(String[] args) {
        Mod05AudioBook book = new Mod05AudioBook("Digital Audio Book Title", "Fiction", 2023, 12, "US-ABC-23-45678", 240);
