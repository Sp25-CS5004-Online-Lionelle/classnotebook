...
//                .sorted((m1, m2) -> m1.getGenre().toLowerCase().compareTo(m2.getGenre().toLowerCase()))
    ...
    public static void main(String[] args) {
        ...
        library.addMedia(new DigitalBook("Digital Book Title", "Fiction", 2023, 300, 12));
        library.addMedia(new MusicMedia("Song Title", "Pop", 2023, "US-ABC-23-45678", 240));
        library.addMedia(new DigitalBook("Digital Song Book Title", "non-Fiction", 2023, 100, 3));
